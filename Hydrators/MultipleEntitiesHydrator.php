...
namespace Potogan\DoctrineBundle\Hydrators;
...
class MultipleEntitiesHydrator extends AbstractHydrator
{
    ...
    protected $_identifierMap;
    protected $_resultPointers;
    protected $_idTemplate;
    protected $_resultCounter;
    protected $_rootAliases = array();
    protected $_initializedCollections = array();
    protected $_existingCollections = array();

    protected $_elementCache = array();
    protected $realResult = array();
     ...
     */
    protected function _initRelatedCollection($entity, $class, $fieldName, $parentDqlAlias)
    {
     ...
     */
    protected function _getEntity(array $data, $dqlAlias)
    {
     ...
     * @return mixed
     */
    protected function _getEntityFromIdentityMap($className, array $data)
    {
     ...
     */
    protected function _getClassMetadata($className)
    {
        if ( ! isset($this->_ce[$className])) {
            $this->_ce[$className] = $this->_em->getClassMetadata($className);
        }
        ...
        foreach ($rowData as $dqlAlias => $data) {
            ...
            if (isset($this->_rsm->parentAliasMap[$dqlAlias])) {
                ...
                if ( ! isset($this->_identifierMap[$dqlAlias][$id[$dqlAlias]])) {
                    ...
                    $this->_elementCache[$dqlAlias][$id[$dqlAlias]] = $element;
                ...
                if ($this->_rsm->isMixed) {
                    $rowres[] = $this->_elementCache[$dqlAlias][$id[$dqlAlias]];
                } else {
                    $rowres = $this->_elementCache[$dqlAlias][$id[$dqlAlias]];
                }
            }
