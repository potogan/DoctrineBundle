...
abstract class AbstractInitializableCollection implements Collection
{
    /**
     * Init state
     *
    ...
    /**
     * Loads/initialize the internal $_elements property and sets $initialized to true
     */
    ...
    public function removeElement($element)
    {
        ...
        foreach ($this->_elements as $k => $elm) {
            if ($res = $elm === $element) {
